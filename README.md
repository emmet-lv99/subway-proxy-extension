...
매일 퇴근길에 반복적으로 지하철 앱을 켜서 열차 위치를 확인해야 하는 번거로움을 해결하고자 시작된 프로젝트입니다. 
개발 과정에서 크롬 익스텐션(Manifest V3) 사양과 공공 API 인프라의 한계점을 마주쳤고, 이를 극복하기 위해 아래 두 가지 핵심 과제를 해결하는 데 집중했습니다.
